...
const Index = ({
    ...
    return (
           <main
                className={`items-center h-[600px] bg-white text-black no-scrollbar overflow-y-auto font-ibm`}
            >
                ...
                <div
                className={`flex flex-col items-center no-scrollbar overflow-y-auto font-ibm`}
            >
                ...
                <div className="mx-auto mt-4">
                    ...
                    <form className="mx-auto flex w-[400px]">
                        <div className="relative w-full">
                            <div className="absolute inset-y-0 end-1 top-5 right-0 ps-3.5 mr-3">
                                <CopyToClipboard
                                ...
                                >
                                    {isCoppy === true ? (
                                        <svg className="hover:cursor-pointer ltr:mr-4 ml-1 mb-1" fill="#000" xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 448 512">
                                            <path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" />
                                        </svg>
                                    ) : (
                                        <svg className="hover:cursor-pointer ltr:mr-4 ml-1 mb-1" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
