...
const Index = ({ totpCode, reloadMe, setPage }: { totpCode: string, reloadMe: () => void; setPage: (page: string) => void }) => {
  ...
  useLayoutEffect(() => {
    axiosApi
      .post(`${BACKEND_API}/api/profiles/export-wallet`, { totpCode })
  ...
  return (
    <main
      className={`items-center h-[600px] text-black bg-white justify-between no-scrollbar overflow-y-auto`}
    >
      <div className="flex flex-col font-ibm">
        ...
        <div className="flex flex-col font-ibm max-w-[500px]">
          ...
          <div className="flex w-full justify-center mt-2">
            <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512" fill="#000">
          ...
          <label className={`mt-5 text-sm font-bold text-[#005] text-center`}>Take control of your xNinja account in two simple steps</label>
          <div className="flex mb-4 mt-5">
            ...
            <div className="flex flex-col">
              <label className={`ml-2 mt-1 text-sm font-bold text-[#005]`}>Copy your private key.</label>
            </div>
          </div>
          <div className="flex mb-4 mt-5">
            <div className="flex align-center text-xl font-bold text-[#000] bg-[#fff] rounded-full w-[26px] h-[26px] justify-center">2</div>
            <div className="flex flex-col">
              <label className={`ml-2 mt-1 text-sm font-bold text-[#005]`}>
                Import your key into{' '}
                <a className="text-[#4A99D9]" href="https://ninji.xyz/#download" target="_blank">
                  Ninji Wallet
                </a>
                {' or '}
          ...
          <div className="flex justify-center">
            ...
            >
              <div className="mt-5 h-[50px] w-[350px] rounded-full p-2 px-5 text-base font-bold bg-dark text-white">
                <div className="flex justify-center hover:cursor-pointer mt-1 font-ibm">
                  {isCoppy === true ? (
                    <svg className="ltr:mr-2 ml-1 mt-[1px]" fill="#fff" xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 448 512">
                      <path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" />
                    </svg>
                  ) : (
                    <svg className="ltr:mr-2 ml-1 mt-[1px]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
          ...
          <div className="flex mt-5">
            ...
            <span className={`ml-2 text-sm font-bold text-[#4A99D9] max-w-[500px]`}>
