...
const Index = ({
    ...
    return (
        <>
            <div
                className={`w-[365px] xxs:w-[420px] xs:w-[500px] bg-white text-black no-scrollbar overflow-y-auto font-ibm`}
            >
                ...
                <div className="mx-auto mt-5">
                    ...
                    <form className="mx-auto flex">
                        <div className="relative w-full border border-gray-300 rounded-xl bg-gray-50">
                            <div className="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                                <svg
                            ...
                            <input
                                type="text"
                                className="outline-none block p-2.5 w-[85%] z-20 ps-10 text-sm text-gray-600 font-semibold bg-gray-50 rounded-xl"
                ...
                <div className="mx-auto mt-5">
                    ...
                    <p className="text-danger text-xs font-ibm py-2">(*)Please note that sending INJ to a centralized exchange (CEX) requires a memo.</p>
                </div>
                ...
                <div className="mx-auto mt-5 flex justify-center">
                    <button
                        disabled={sending}
                        type="button"
                        className="w-full text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 justify-center inline-flex items-center disabled:hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-[0.8]"
                        onClick={() => {
                            ...
                            if (!totpCode.includes(' ') && totpCode.length === 6) {
                                axiosApi
                                    .post(
                                        `${import.meta.env.VITE_API_URL}/api/blockchain/withdraw`,
                                        {
