        ...
        <>
            <div className="flex flex-col">
                ...
                <div className="flex flex-col">
                    ...
                    <label className="text-white text-xl font-bold">Protect your account in just two steps</label>
                    ...
                    <div className="flex mb-5 mt-5">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="max-w-[360px]">Two-factor authentication will then be turned on for authentication app, which you can turn off at any time.</span>
                        </div>
                    </div>
...
export const SecondPage = ({ setPage }: { setPage: (page: string) => void }) => {
            ...
            <>
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex mb-5 mt-5 justify-center">
                            <div className="overflow-hidden flex border border-gray-700 rounded-lg h-12 w-full max-w-[360px]">
                                <p className={`'text-black' text-md font-bold ml-3 mt-3`}>{secret}</p>
...
export const ThirdPage = ({ setPage, updateSession }: { setPage: (page: string) => void; updateSession: (session: Session | null) => void }) => {
    ...
    const enable2FA = async () => {
        try {
            await axios.post(`/api/auth/two-factor/enable`, { totpCode });
            const session = await getSession();
            updateSession(session);
            setPage('2fa_page_4');
        } catch (error: any) {
            error.response.status === 403 && signOut({ callbackUrl: '/' });
            error.response.status === 400 && toast.error('Your 2FA code is not valid!', { duration: 3000, className: 'font-pixel text-black' });
            error.response.status === 500 && toast.error(`Sorry something went wrong!`, { duration: 3000, className: 'font-pixel text-black' });
        }
    };
    ...
    return (
        <>
            <div className="flex flex-col">
                ...
                <div className="flex flex-col">
                    <label className="text-white text-xl font-bold">Enter the confirmation code</label>
                    <div className="flex mt-5 justify-center">
                        <div className="flex flex-col">
                            <span className="max-w-[360px]">Enter the Confirmation code that you get from the Authentication app below.</span>
                        </div>
                    </div>
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (!totpCode.includes(' ')) {
                                    ...
                                    toast.error('Your 2FA code is not valid!', { duration: 3000, className: 'font-pixel text-black' });
                                }
                            }}
                        >
                            Next
...
export const FourthPage = ({ setPage }: { setPage: (page: string) => void }) => {
    const dispatch = useDispatch();
        ...
        <>
            <div className="flex flex-col">
                ...
                <div className="flex flex-col">
                    ...
                    <label className="text-white text-xl font-bold mt-5">You’re all set</label>
                    <div className="flex mb-5 mt-2">
                        <div className="flex flex-col">
                            <span className="max-w-[360px]">You have successfully set up two-factor authentication for your XNINJA account.</span>
                        </div>
                    </div>
...
export const Verify2FA = ({ onVerify }: { onVerify: (state: boolean) => void }) => {
    const [totpCode, setTotpCode] = useState('');
    ...
    const verify2FA = async () => {
        try {
            await axios.post(`/api/auth/two-factor/verify`, { totpCode });
            onVerify(true);
        } catch (error: any) {
            error.response.status === 403 && signOut({ callbackUrl: '/' });
            error.response.status === 400 && toast.error('Your 2FA code is not valid!', { duration: 3000, className: 'font-pixel text-black' });
        ...
        <>
            <div className="flex flex-col">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex mt-5 justify-center">
                        <div className="flex flex-col">
                            <span className="max-w-[360px]">Enter the Confirmation code that you get from the Authentication app.</span>
                        </div>
                    </div>
                    <div className="flex mb-0 mt-5 justify-center">
                        <div className="overflow-hidden flex rounded-lg h-20 w-full max-w-[360px] flex-col">
