...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        setPageTitle(state, { payload }) {
            document.title = `${payload} | XNinja - the first X-SocialFi game built on Injective`;
        },
...
export const { toggleTheme, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleLocale, toggleSidebar, setPageTitle, setShowHeader } = themeConfigSlice.actions;
